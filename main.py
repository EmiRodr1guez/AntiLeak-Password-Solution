...
if count <= 0:
    ...
    sleep(1)
    print(
        "That being said, true security matters. Hence why you should come back periodically to ensure your passwords are safe\n")
    sleep(1)
    ...
    print(
        Fore.RED + f"Password 1: {userPass + password1} // Strength of this password is => {round(stats.strength(), 2)}")
    sleep(1)
    stats = PasswordStats(userPass + password2)
    print(
        Fore.BLUE + f"Password 2: {userPass + password2} // Strength of this password is => {round(stats.strength(), 2)}")
    sleep(1)
    stats = PasswordStats(userPass + password3)
    print(
        Fore.GREEN + f"Password 3: {userPass + password3} // Strength of this password is => {round(stats.strength(), 2)}")
    sleep(1)
    stats = PasswordStats(userPass + password4)
    print(
        Fore.CYAN + f"Password 4: {userPass + password4} // Strength of this password is => {round(stats.strength(), 2)}")
